...
public class Person2 implements Serializable {
	...
	public static void main(String[] args) throws Exception {
	 ...
	 System.out.println(person);//Person [id=10, name=Raju, email=raju@gmail.com, pwd=raju@123]
	...
	System.out.println(p.id +" ::: "+p.name); //10 ::: Raju
	System.out.println(p);  //Person [id=10, name=Raju, email=raju@gmail.com, pwd=null]
